...
import { getResourceById, updateResource } from '@/lib/storage'
import { RESOURCE_CATEGORIES } from '@/types'
import type { Resource, CreateResourceFormData, ResourceType } from '@/types'
...
export default function EditResourcePage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    updateResource(params.id as string, formData)
    ...
    return (
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center">
          <h2 className="text-xl font-semibold mb-2">资源不存在</h2>
          <Button asChild>
            <Link href="/resources">返回资源列表</Link>
          </Button>
        </div>
      </div>
    )
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container py-8 max-w-2xl">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-2xl font-bold">编辑资源</h1>
        </div>
